...
internal fun Context.getThemePrimaryColor(): Int {
    ...
    this.theme.resolveAttribute(de.dlyt.yanndroid.oneui.R.attr.colorPrimary, value, true)
    return value.data
}
...
internal val de.dlyt.yanndroid.oneui.view.ViewPager2.isNotEmpty: Boolean get() = (adapter?.itemCount ?: 0) > 0
...
internal val de.dlyt.yanndroid.oneui.view.ViewPager2?.isEmpty: Boolean get() = this?.adapter?.itemCount == 0
