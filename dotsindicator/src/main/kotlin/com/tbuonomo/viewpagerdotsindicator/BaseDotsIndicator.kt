...
import com.tbuonomo.viewpagerdotsindicator.attacher.ViewPagerOUIAttacher
...
abstract class BaseDotsIndicator @JvmOverloads constructor(
    ...
    fun attachTo(viewPager2: de.dlyt.yanndroid.oneui.view.ViewPager2) {
        ViewPagerOUIAttacher().setup(this, viewPager2)
    }
